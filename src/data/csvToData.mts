...
function mapToBatches(images: Omit<Images[Theme], "images">) {
  return ([batchNumber, levelData]: [string, ThemeCsvLevel[]]) => {
...
export function csvToData(data: ThemeCsvLevel[], themeImages?: Images[Theme]) {
