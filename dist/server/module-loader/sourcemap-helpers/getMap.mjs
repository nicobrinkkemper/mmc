...
export const getMap = (source, options) => {
    ...
    source.streamChunks({ ...options, source: false, finalSource: true }, (_chunk, generatedLine, generatedColumn, sourceIndex, originalLine, originalColumn, nameIndex) => {
...
//# sourceMappingURL=getMap.mjs.map