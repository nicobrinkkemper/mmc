...
import { build, moduleBaseURL, modules, node_modules, root, rsc_port, ssr_port, } from "./constants.js";
...
<body><div id="root">`);
    ...
    const rscStream = Readable.fromWeb(rsc.body);
    let App = () => {
    ...
    .listen(ssr_port);
new Worker(resolve(root, "dist/server/export.mjs")).addListener("close", (_) => console.log("Pages exported successfully! 🚀"));
//# sourceMappingURL=ssr-server.mjs.map