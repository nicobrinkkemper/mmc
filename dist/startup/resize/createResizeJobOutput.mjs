 ...
 */
export async function createResizeJobOutput(job) {
    ...
    if (shouldOutput) {
        ...
        if (job.userInfo.strict)
            console.log("strict file", file);
    }
    return {
...
//# sourceMappingURL=createResizeJobOutput.mjs.map