...
export async function readDirectoryRecursive(path, allowedExtensions, basePath = "") {
    try {
        ...
        for (const fileName of fileNames) {
            ...
            if (stats.isDirectory()) {
                ...
                // recursion
                const nestedResult = await readDirectoryRecursive(itemPath, allowedExtensions, relativePath);
                result = {
...
//# sourceMappingURL=readDirectoryRecursive.mjs.map