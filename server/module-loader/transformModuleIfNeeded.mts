  ...
  try {
    program = parse(source, {
      ...
      onComment(
        ...
        startLoc: { line: number; column: number } | undefined,
        endLoc: { line: number; column: number } | undefined
      ) {
        if (
          text.startsWith("# sourceMappingURL=") ||
          text.startsWith("@ sourceMappingURL=")
        ) {
          sourceMappingURL = text.slice(19) as string;
  ...
  if (sourceMappingURL) {
    ...
    const sourceMapString =
      typeof sourceMapResult.source === "string"
        ...
        : (sourceMapResult.source.toString as (s?: "utf8" | never) => string)(
            "utf8"
          );
