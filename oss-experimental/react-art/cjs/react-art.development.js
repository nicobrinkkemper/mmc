...
"production" !== process.env.NODE_ENV &&
  (function () {
      ...
      JSCompiler_temp
        ...
        : 0 !== (lane & 4194176) &&
          ...
          0 > transitionStartTime &&
            ((transitionEventTime = -1.1), (transitionEventType = null)));
    }
            ...
            case 13:
              return (
                ...
                value === noopSuspenseyCommitThenable
                  ...
                  : ((returnFiber = suspenseBoundary.updateQueue),
                    null === returnFiber
                  ...
                  : ((returnFiber = suspenseBoundary.updateQueue),
                    null === returnFiber
                      ? ((returnFiber = {
                        ...
                        (suspenseBoundary.updateQueue = returnFiber))
                      : ((suspenseBoundary = returnFiber.retryQueue),
                        null === suspenseBoundary
                          ? (returnFiber.retryQueue = new Set([value]))
                          : suspenseBoundary.add(value)),
                    attachPingListener(root, value, rootRenderLanes)),
                !1
              );
          }
        ...
        switch (suspenseBoundary.tag) {
          case 3:
            return (
              ...
              (suspenseBoundary.lanes |= root),
              (root = createRootErrorUpdate(
                suspenseBoundary.stateNode,
                value,
                root
              )),
              enqueueCapturedUpdate(suspenseBoundary, root),
              !1
            );
          case 1:
            if (
              ((returnFiber = suspenseBoundary.type),
              (sourceFiber = suspenseBoundary.stateNode),
              0 === (suspenseBoundary.flags & 128) &&
              ...
              return (
                ...
                enqueueCapturedUpdate(suspenseBoundary, rootRenderLanes),
                !1
              );
        }
        suspenseBoundary = suspenseBoundary.return;
      } while (null !== suspenseBoundary);
      return !1;
    }
          ...
          a: {
            ...
            switch (exitStatus) {
              ...
              case RootSuspendedWithDelay:
                if ((lanesThatJustErrored & 4194176) === lanesThatJustErrored) {
                  markRootSuspended(
                    renderWasConcurrent,
            ...
            renderWasConcurrent.finishedLanes = lanesThatJustErrored;
            if (null !== ReactSharedInternals.actQueue) {
              forceSync = renderWasConcurrent;
              exitStatus = workInProgressRootRecoverableErrors;
              renderWasConcurrent = workInProgressTransitions;
              lanesThatJustErrored =
                workInProgressRootDidIncludeRecursiveRenderUpdate;
              originallyAttemptedLanes = workInProgressDeferredLane;
              var updatedLanes = workInProgressRootInterleavedUpdatedLanes,
                suspendedRetryLanes = workInProgressSuspendedRetryLanes,
                suspendedCommitReason = IMMEDIATE_COMMIT,
                completedRenderStartTime = renderStartTime,
              ...
              if (
                (lanesThatJustErrored & 62914560) === lanesThatJustErrored &&
                ((exitStatus =
    ...
    function prepareFreshStack(root, lanes) {
      ...
      -1 !== updateTime &&
        ((root.timeoutHandle = -1), cancelTimeout(updateTime));
