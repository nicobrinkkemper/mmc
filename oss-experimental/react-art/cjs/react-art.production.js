...
function markRootFinished(root, finishedLanes, remainingLanes, spawnedLane) {
  ...
  for (
    ...
    previouslyPendingLanes = 1 << index$5;
    finishedLanes[index$5] = 0;
...
function throwException(
  ...
  do {
    switch (returnFiber.tag) {
      ...
      case 1:
        if (
          ((suspenseBoundary = returnFiber.type),
          (sourceFiber = returnFiber.stateNode),
          0 === (returnFiber.flags & 128) &&
            ("function" === typeof suspenseBoundary.getDerivedStateFromError ||
              (null !== sourceFiber &&
        ...
        a: for (current = null, wasHidden = finishedWork; ; ) {
          if (5 === wasHidden.tag) {
            if (null === current) {
              ...
              try {
                if (((existingHiddenCallbacks = root.stateNode), instance))
