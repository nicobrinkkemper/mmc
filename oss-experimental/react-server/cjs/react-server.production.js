...
module.exports = function ($$$config) {
            ...
            if (null !== request.trackedPostpones) {
              ...
              try {
                ...
                (newBoundary.status = 4),
                  ...
                  null !== JSCompiler_inline_result &&
                  JSCompiler_inline_result.$$typeof === REACT_POSTPONE_TYPE
                    ? (logPostpone(
                        request,
                        JSCompiler_inline_result.message,
                        contextType
                      ),
  ...
  function trackPostpone(request, trackedPostpones, task, segment) {
    ...
    if (null === boundary)
      ...
      if (null !== boundary && 0 === boundary.status) {
        ...
        var boundaryNode$26 = trackedPostpones.workingMap.get(boundaryKeyPath);
        void 0 === boundaryNode$26
          ? ((boundaryNode$26 = [
              boundaryKeyPath[1],
              boundaryKeyPath[2],
              children,
            ...
            trackedPostpones.workingMap.set(boundaryKeyPath, boundaryNode$26),
            addToReplayParent(
              boundaryNode$26,
              boundaryKeyPath[0],
              trackedPostpones
            ))
          : ((boundaryKeyPath = boundaryNode$26),
  ...
  function abortTask(task, request, error) {
    ...
    if (null === boundary) {
      ...
      boundary.pendingTasks--;
      var trackedPostpones$41 = request.trackedPostpones;
      if (4 !== boundary.status) {
        if (null !== trackedPostpones$41 && null !== segment)
          return (
            "object" === typeof error &&
            null !== error &&
            error.$$typeof === REACT_POSTPONE_TYPE
              ? logPostpone(request, error.message, errorInfo)
              : logRecoverableError(request, error, errorInfo),
            trackPostpone(request, trackedPostpones$41, task, segment),
                  ...
                  if (
                    ...
                    if ("object" === typeof x$jscomp$0 && null !== x$jscomp$0) {
                      ...
                      if (
                        ...
                        var trackedPostpones$45 = request.trackedPostpones;
                        task.abortSet.delete(task);
