/**
 * @license React
 * react-noop-renderer-persistent.production.js
 *
...
var ReactFiberReconciler = require("react-reconciler"),
  ...
  NO_CONTEXT = {},
  UPPERCASE_CONTEXT = {},
  _createReactNoop = (function (reconciler, useMutation) {
      ...
      sharedHostConfig = {
        ...
        suspendInstance: function (type, props) {
          ...
          if ("suspensey-thing" === type && "string" === typeof props) {
            ...
            if (void 0 === type) throw Error("Could not find record for key.");
            "fulfilled" !== type.status &&
              "pending" === type.status &&
      ...
      ReactNoop = {
        ...
        dumpTree: function () {
          ...
          if (root && rootID) {
            var bufferedLog = [];
            log("HOST INSTANCES:");
            log("  ".repeat(0) + "- [root#" + rootID.rootID + "]");
            logHostInstances(rootID.children, 1);
            log("FIBERS:");
  ...
  dangerouslyGetPendingChildren =
    _createReactNoop.dangerouslyGetPendingChildren,
...
exports._Scheduler = _createReactNoop._Scheduler;
exports.act = act;
